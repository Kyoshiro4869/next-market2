...
const ImgInput = (props) => {
    ...
    const handleClick = async() => {
        try{
            ...
            data.append("upload_preset", "llaokdsh")
            data.append("cloud_name","dejhvlgsd")
            const response= await fetch("https://api.cloudinary.com/v1_1/dejhvlgsd/image/upload", {method: "POST", body: data})
